...
Developed and tested in Matlab R2016b, under Windows 7 and Windows 10.
...
All tests should pass, results and figures will be saved in the automatically created results folder. 
