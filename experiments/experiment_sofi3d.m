...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
settings.io.imagePath = 'data\sofi3d\test_main\20210615\input';
settings.io.imageName = []; % if empty, all the files in the path will be processed
settings.io.pnc = 'data\sofi3d\test_main\20210615\input\calibration'; % calibration
...
% test outputpath
settings.io.outputpath = 'data\sofi3d\test_main\20210615\result';
