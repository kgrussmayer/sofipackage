...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
settings.io.imagePath =  'data\sofi2d\test_main\20210615\input';
...
% LBEN_PALM: molecule localisations from PALM setup
...
settings.sys.subseqlength = 2000; % length of a subsequence used for cumulant calculation
...
settings.dec.iter = 5; % number of iterations for Richardson-Lucy deconvolution, 5 is default
...
%--- 2D SOFI ---%
settings.sys.pxy = 108; % projected pixel size (in xy) [nm]  sofisetup = 96.0384, PALM setup = 104.8, AD-gut setup = 108
% Linearization settings
settings.dec.denoise = 0; % option to turn off/on {0, 1}
...
% test outputpath
settings.io.outputpath = 'data\sofi2d\test_main\20210615\result\output'; 
