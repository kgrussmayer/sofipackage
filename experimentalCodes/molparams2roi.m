function [ratio,density,dens,nummol] = molparams2roi(sofi_c,sofi_lin,settings,roix,roiy,ii)
...
%         [ratio,density,brightness]=sofiParameters(sofi_c);
        ...
        density = medfilt2(I_density,[2 2]);
...
if settings.io.figs ==1   
    ...
    if settings.io.figsave ==1
        save2pdf([settings.io.outputpath,filesep,settings.io.imageName,'_onratio_',num2str(ii),'.pdf'],gcf,300);
        saveFigure(gcf,settings.io.outputpath,[settings.io.imageName,'_onratio_',num2str(ii)],'png');
    end
    ...
    if settings.io.figsave ==1
        save2pdf([settings.io.outputpath,filesep,settings.io.imageName,'_density_v2_',num2str(ii),'.pdf'],gcf,300);
        saveFigure(gcf,settings.io.outputpath,[settings.io.imageName,'_density_v2_',num2str(ii)],'png');
    end
    ...
    set(gca,'yaxislocation','right');
    if settings.io.figsave ==1
        save2pdf([settings.io.outputpath,filesep,settings.io.imageName,'_density_v1_',num2str(ii),'.pdf'],gcf,300);
        saveFigure(gcf,settings.io.outputpath,[settings.io.imageName,'_density_v1_',num2str(ii)],'png');
    end
