function [sofi,grid]=mcSofiCumulants(stacks,first,frames,region,orders,gpu)
% Calculate raw cross-spectral cumulant images from image stacks.
%
% Inputs:
...
try
    ...
    grid=mcSofiGrids(orders,3);           % 3D partitions and pixels
